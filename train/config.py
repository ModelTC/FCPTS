...
_C.EXTRA = CN()
_C.EXTRA.nesterov = False
_C.EXTRA.no_bn_decay = False
_C.EXTRA.st_decay = None
_C.EXTRA.sInit_value = -3200

_C.EXTRA.target_sparsity = 0.8
_C.EXTRA.sparsity_loss_type = 'abs'
_C.EXTRA.sparsity_lambda = 1.0

_C.EXTRA.sparse_table_file = None
_C.EXTRA.use_intel_layer_loss = False
...
def update_config(config, args):
    ...
    if args.sInit_value:
        config.EXTRA.sInit_value = args.sInit_value

    if args.target_sparsity:
        config.EXTRA.target_sparsity = args.target_sparsity
    if args.sparsity_loss_type:
        config.EXTRA.sparsity_loss_type = args.sparsity_loss_type
    if args.sparsity_lambda:
        config.EXTRA.sparsity_lambda = args.sparsity_lambda

    if args.sparse_table_file:
        config.EXTRA.sparse_table_file = args.sparse_table_file
    if args.use_intel_layer_loss:
        config.EXTRA.use_intel_layer_loss = args.use_intel_layer_loss
